...
fentanyl, oxycodone). v0.9 - three new safety checks added: route
caution (flags dosing on a route the thresholds weren't verified for -
e.g. IV paracetamol, or an impossible injectable loratadine order),
penicillin-class allergy checking for amoxicillin, and a narrow
opioid + CNS-depressant interaction flag for fentanyl/oxycodone. See
README v0.9 notes for full detail.
